 ...
 */
public abstract class KafkaTableSink10 implements AppendStreamTableSink<Row> {
     ...
     */
    protected abstract FlinkKafkaProducer010<Row> createKafkaProducer(
     ...
     */
    protected abstract KafkaTableSink10  createCopy();

    @Override
    public void emitDataStream(DataStream<Row> dataStream) {
        FlinkKafkaProducer010 <Row> kafkaProducer = createKafkaProducer(topic, properties, serializationSchema, partitioner);
    ...
    @Override
    public KafkaTableSink10  configure(String[] fieldNames, TypeInformation<?>[] fieldTypes) {
        KafkaTableSink10  copy = createCopy();
